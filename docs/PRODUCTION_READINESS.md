...
Remote provisioning completed: D1 `ghostwriter` (`a8f36e7e-ea90-4413-91da-9b3219551098`), both migrations applied; OAuth KV namespace `d8f21913223f4e7a8cd8a199a5a28b5e`. The owner subsequently selected a deployment without R2; its binding and image-generation MCP tool are disabled in the personal configuration. The personal Worker is deployed on the confirmed Workers Free plan. Live HTTPS health, OAuth registration/consent/token issuance, MCP initialize and tools/list have passed at `https://ghostwriter.ghostwriter-cloudflare.workers.dev/mcp`. Discovery returns 10 tools and excludes image generation. Publishing remains disabled. The owner authentication secret is installed. No AI or Meta credentials have been provisioned.
